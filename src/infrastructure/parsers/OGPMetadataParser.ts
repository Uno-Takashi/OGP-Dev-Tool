...
const TAG_DEFINITIONS: TagDefinition[] = [
  ...
  {
    tag: 'meta',
    tipKey: 'ogp.tips.ogImageSecureUrl',
    name: 'property',
    ogpType: 'og:image:secure_url',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.ogImageType',
    name: 'property',
    ogpType: 'og:image:type',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.ogImageWidth',
    name: 'property',
    ogpType: 'og:image:width',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.ogImageHeight',
    name: 'property',
    ogpType: 'og:image:height',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.ogImageAlt',
    name: 'property',
    ogpType: 'og:image:alt',
    content: 'content',
  },
  // X (Twitter) Card
  {
  ...
  {
    tag: 'meta',
    tipKey: 'ogp.tips.twitterCreator',
    name: 'name',
    ogpType: 'twitter:creator',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.twitterTitle',
    name: 'name',
    ogpType: 'twitter:title',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.twitterDescription',
    name: 'name',
    ogpType: 'twitter:description',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.twitterImage',
    name: 'name',
    ogpType: 'twitter:image',
    content: 'content',
  },
  // Facebook
  {
  ...
  {
    tag: 'meta',
    tipKey: 'ogp.tips.articleAuthor',
    name: 'property',
    ogpType: 'article:author',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.articlePublishedTime',
    name: 'property',
    ogpType: 'article:published_time',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.articleModifiedTime',
    name: 'property',
    ogpType: 'article:modified_time',
    content: 'content',
  },
  {
    tag: 'meta',
    tipKey: 'ogp.tips.articleSection',
    name: 'property',
    ogpType: 'article:section',
    content: 'content',
  },
];
